...
same position from the same file will always return the same result.  The same holds for listing directories,
...
mitigation strategies - such as a less sophisticated detection method that does not attempt to cover all
scenarios.
