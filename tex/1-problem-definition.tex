...
The obvious way to represent a path is by using an absolute path string, i.e. one that specifies all path
...
Clients have no way of knowing whether the rename/move operation crosses filesystem boundaries
